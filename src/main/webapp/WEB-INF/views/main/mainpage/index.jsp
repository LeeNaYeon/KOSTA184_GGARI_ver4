...
.testimonial2 .sec-title h2, .testimonial2 .sec-title p {
	color: #ffffff;
}
...
<div class="banner-slider">
	<div class="main-slider owl-carousel owl-theme">
		<div class="slider-items"
			style="background-image:url(${pageContext.request.contextPath}/resources/images/slider/main.jpg); height=">
		...
		<div class="slider-items"
			style="background-image:url(${pageContext.request.contextPath}/resources/images/slider/main2.jpg);">
			<div class="slider-overlay"></div>
			<div class="slider-content">
				<div class="carousel-caption caption-center">
					<div class="content">
						<h2>Let's code together</h2>
						<p>문구 들어갈 자리 입니다. 같이 정해보아요^^</p>
						<a href="${pageContext.request.contextPath}/countTest"
							class="btn btn-primary">더 알아보기</a>
					</div>
				</div>
			</div>
		</div>
...
<section class="popular-course section grey-background">
	<div class="container">
		<div class="title sec-title">
			<h2>추천 강좌</h2>
			<p>문구가 들어갈 자리입니다. 문구가 들어갈 자리입니다. 문구가 들어갈 자리입니다. 문구가 들어갈 자리입니다.
				문구가 들어갈 자리입니다. 문구가 들어갈 자리입니다.</p>
			<p>
				<a href="course">전체강좌 보러가기</a>
			</p>
		</div>
			...
			<div class="course-carousel owl-carousel owl-theme">
				<div class="course-item">
					<div class="course-img ">
						<img
							class="${pageContext.request.contextPath}/resources/img-responsive "
					...
					<div class="course-detail ">
						...
						<h3>
							<a href="courses.html " title="Details ">Aeronautical
								Engineering </a>
						</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							Phasellus tincidunt mauris id tortor iaculis, ut mollis mi
							sagittis.</p>
						...
						<div class="course-bottom">
							<span><i class="fa fa-users"></i>365</span> <span><i
								class="fa fa-comment"></i>7</span> <span class="pull-right">$60.00</span>
						</div>
					</div>
				</div>
				<div class="course-item">
					...
					<div class="course-detail ">
						...
						<h3>
							<a href=" courses.html" title="Details ">Complet Guied of
								Business</a>
						</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							Phasellus tincidunt mauris id tortor iaculis, ut mollis mi
						...
						<div class="course-icon">
							<img
								src="${pageContext.request.contextPath}/resources/images/users/2.jpg"
								class="img-responsive" alt="image">
						</div>
						<div class="course-bottom">
							<span><i class="fa fa-users"></i>365</span> <span><i
								class="fa fa-comment"></i>7</span> <span class="pull-right free">free</span>
						</div>
					</div>
				</div>
				<div class="course-item">
					...
					<div class="course-img ">
						<img class="img-responsive "
							src="${pageContext.request.contextPath}/resources/images/course/3.jpg "
							alt="image" />
					</div>
					<div class="course-detail ">
						<div class="course-date">
						...
						<h3>
							<a href="courses.html" title="Details ">Learning Ui&Ux Design
							</a>
						</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							Phasellus tincidunt mauris id tortor iaculis, ut mollis mi
				...
				<div class="course-item">
					...
					<div class="course-detail ">
						...
						<h3>
							<a href="courses.html " title="Details ">computer and IT
								courses. </a>
						</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
							Phasellus tincidunt mauris id tortor iaculis, ut mollis mi
...
<section class="lecture section grey-background pdb0">
	...
	<div class="title sec-title" id="leveltestImg">
		<img
			src="${pageContext.request.contextPath}/resources/images/levelTest.PNG"
			class="img-responsive" alt="image">
	</div>
	<div class="lecture-bg">
		<img
			src="${pageContext.request.contextPath}/resources/images/background/backgroundimg2.png"
			class="img-responsive" alt="image">
	</div>
</section>
...
<section class="testimonial section"
	style="background: url(${pageContext.request.contextPath}/resources/images/background/common.jpg) no-repeat;">
			...
			<div class="testimonial-carousel owl-carousel owl-theme">
				<div class="testimonial-item">
					...
					<div class="testi-content">
						...
						<span> ${mentoRepList[0].repContent} </span>
					</div>
				</div>
				<div class="testimonial-item">
					<div class="testi-img">
					...
					<div class="testi-content">
						...
						<span> ${mentoRepList[1].repContent} </span>
					</div>
				</div>
				<div class="testimonial-item">
					<div class="testi-img">
					...
					<div class="testi-content">
						...
						<span> ${mentoRepList[2].repContent} </span>
					</div>
				</div>
				<div class="testimonial-item">
					<div class="testi-img">
					...
					<div class="testi-content">
						...
						<span> ${mentoRepList[3].repContent} </span>
					</div>
				</div>
			</div>
		</div>
