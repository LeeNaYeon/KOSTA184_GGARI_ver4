                ...
                <div class="col-md-4">
                  <div class="sidebar">
                   <div class="sidebar-widget category-widget">
				    ...
				    <ul>
                      <li>
                        <a ${pageContext.request.contextPath}/admin/memberMgr/mentoSelectList">멘토회원</a>
                      </li>
                      <li>
                        <a ${pageContext.request.contextPath}/admin/memberMgr/menteeSelectList">멘티회원</a>
                      </li>
                    </ul>                    
                	</div>
                  </div>
                    ...
                    <div class="col-md-8">
                   	 <div><h3  class="mentoImage" style="font-size: 20px"><img alt="mentoImage" src="${pageContext.request.contextPath}/resources/images/mentoImage.png";>멘토회원</h3></div>
                        	<!-- 관리자 멘토신청자 명단 리스트 화면 -->
